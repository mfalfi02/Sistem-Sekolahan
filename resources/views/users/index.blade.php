        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-white/10 text-left">
                ...
                <tbody class="divide-y divide-white/10">
                        ...
                        <tr data-table-filter-row class="hover:bg-white/5">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <form method="POST" action="{{ route('users.destroy', $user) }}" data-confirm="Hapus user ini?">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-10 text-center text-sm text-slate-400">Belum ada user.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
